...
public interface Constants {
	...
	public final String TodoList = "todo";
	public final String ResubmissionList = "resubmission";
	public final String ArchivList = "archiv";
	public final String TrashList = "trash";
